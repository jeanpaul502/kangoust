...
import { Mail, Lock, Eye, EyeOff, User, ArrowLeft, HelpCircle } from 'lucide-react';
                        ...
                        <div className="bg-white rounded-[28px] border border-[#E4E9F2] p-8 sm:p-14 shadow-[0_20px_50px_rgba(16,36,94,0.06)]">
                            ...
                            <div className="flex flex-col items-center text-center mb-10">
                                ...
                                <p className="text-[15px] text-[#64718F] font-[450] max-w-md leading-relaxed">
                                    Créez votre compte pour commencer votre aventure en Australie.
                                </p>
                            </div>
                            ...
                            <form onSubmit={handleSubmit} className="space-y-5">
                                ...
                                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                    {/* Prénom */}
                                    <div>
                                        <label htmlFor="firstName" className="block text-[14px] font-bold text-[#10245E] mb-2">
                                            Prénom
                                        </label>
                                    ...
                                    {/* Nom */}
                                    <div>
                                        <label htmlFor="lastName" className="block text-[14px] font-bold text-[#10245E] mb-2">
                                            Nom
                                        </label>
                                        <div className="relative">
                                            <div className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none text-[#64718F]">
                                ...
                                <div className="pt-1">
                                    <label className="flex items-start gap-2.5 cursor-pointer select-none group">
                                        <input
                                            ...
                                            className="w-4 h-4 mt-0.5 rounded-[4px] border-[#D9E1EE] text-[#2F67D8] focus:ring-[#2F67D8]/20 focus:ring-offset-0 cursor-pointer accent-[#2F67D8]"
                                            required
                                        />
                                        <span className="text-[13.5px] leading-snug font-medium text-[#64718F] group-hover:text-[#10245E] transition-colors">
                                            J'accepte les{' '}
                                            <Link href="#terms" className="text-[#2F67D8] font-semibold hover:underline">
                                                Conditions Générales d'Utilisation
                                            </Link>{' '}
                                            et la{' '}
                                            <Link href="#privacy" className="text-[#2F67D8] font-semibold hover:underline">
